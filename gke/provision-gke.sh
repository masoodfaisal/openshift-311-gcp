...
# #get the credentials of existing GKE cluster
...
# export CLUSTER_NAME=gke-native
...
export CLUSTER_ZONE=australia-southeast1-a
export KNATIVE_PROJECT=fm-gke-knative
...
## demo here
#https://github.com/idvoretskyi/knative-demo
